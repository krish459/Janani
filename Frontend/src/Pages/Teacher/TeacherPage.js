...
class TeacherPage extends Component{
    ...
    <Layout >
     ...
     <div className="Teacher-Courses-Buttons-head">
            ...
            <button onClick={()=> this.categoryHandler("Technical")} className={classWeb.join(' ')} > Technical</button>
                <button className={classWebDesign.join(' ')} onClick={()=> this.categoryHandler("Stitching")}> Stitching</button>
                <button className={classReact.join(' ')} onClick={()=> this.categoryHandler("Cooking")}> Cooking</button>
                <button className={classML.join(' ')} onClick={()=> this.categoryHandler("Finance")}> Finance</button>
                <button className={classPhotography.join(' ')} onClick={()=> this.categoryHandler("Photography")}> Photography</button>
                <button className={classNodeJs.join(' ')} onClick={()=> this.categoryHandler("Schooling")}>Schooling</button>
