...
class TeacherPage extends Component{
    ...
    CourseNames:["Technical","Cooking", "Finance","Stiching","Schooling",
                "Photography"],
    isLoggedIn:false,
    userName:"",
    alertPressed:false,
   ...
   //     let fileName=null;
        ...
        if(this.state.Form.category['Schooling']){
          ...
          data = (   <>
            ...
            <div className="Welcome-msg">
                    ...
                    <div className="Teacher-Courses-Buttons">
                        ...
                        <button onClick={()=> this.categoryHandler("Technincal")} className={classWeb.join(' ')} > Development</button>
                        <button className={classWebDesign.join(' ')} onClick={()=> this.categoryHandler("Stitching")}> Designing</button>
                        <button className={classReact.join(' ')} onClick={()=> this.categoryHandler("Cooking")}> React</button>
                        <button className={classML.join(' ')} onClick={()=> this.categoryHandler("Finance")}> ML</button>
                        <button className={classPhotography.join(' ')} onClick={()=> this.categoryHandler("Photography")}> Photography</button>
                        <button className={classNodeJs.join(' ')} onClick={()=> this.categoryHandler("Schooling")}> Node JS</button>
